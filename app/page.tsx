        ...
        <div className="container mx-auto px-4 py-8 md:py-12">
          ...
          >
            ...
            >
              ...
              >
                <a
                  href="/Nha_Le_Thanh_CV.pdf"
                  download="Nha_Le_Thanh_CV.pdf"
                >
                  <Download size={16} />
                  Download CV
                </a>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
                      <li className="transition-transform hover:translate-x-1">
                        ...
                        Developer, proficient in 2 programming languages Golang
                        and PHP.
                      </li>
                      <li className="transition-transform hover:translate-x-1">
            ...
            <AnimatedCard>
              <CardHeader className="pb-2">
                <CardTitle className="flex items-center gap-2">
                  <Award
                    size={20}
                    className="text-blue-500 transition-transform hover:rotate-12"
                  />
                  Certifications
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="space-y-1 transition-transform hover:translate-x-1">
                    <div className="flex justify-between">
                      <p className="text-sm font-medium">
                        Certificate of completion for the Golang Basic course
                      </p>
              ...
              <CardContent className="space-y-8">
                ...
                <AnimatedSection delay={100} direction="right">
                  <div className="space-y-3">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                      ...
                      <Badge
                        variant="outline"
                        className="w-fit mt-1 sm:mt-0 animate-pulse"
                    ...
                    <div>
                      ...
                      <ul className="list-disc pl-5 mt-1 space-y-1 text-sm">
                        ...
                        <li className="transition-transform hover:translate-x-1">
                          Write APIs for analyzing audio transcripts, scoring
                          criteria, and managing QC-related configurations.
                        </li>
                        <li className="transition-transform hover:translate-x-1">
                ...
                <AnimatedSection delay={200} direction="right">
                  <div className="space-y-3">
                    ...
                    <div className="mt-4">
                      <p className="font-medium text-sm">
                        Project: Golang Clean Architecture (1/2023 - 6/2023)
                      </p>
                      <p className="font-medium text-sm mt-2">
                    ...
                    <div className="mt-4">
                      <p className="font-medium text-sm">
                        Project: Nursing Home Management System (8/2022 -
                        1/2023)
                      </p>
                      <p className="font-medium text-sm mt-2">
